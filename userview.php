    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="userview.php">User List</a></li>
          
        </ul>
      </div>
    </div>
	
	<h1 style="color:#00C6F0;text-align:center; font-size:30px;"><b>User List</h1>
	<?php
...
$data=mysqli_query($con1,$sql);
 ...
 <ul id="menu" >
          ...
          <li ><a href="book.html">Upload Book</a></li>
          <li><a href="adminupdate.php">View Book List</a></li>
